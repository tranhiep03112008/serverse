...
cc.Class({
	...
	onSignNameClick: function() {
		if (this.username.string.length > 16 || this.username.string.length < 6 || this.username.string.match(new RegExp("^[a-zA-Z0-9]+$")) === null){
			cc.RedT.inGame.notice.show({title:"", text:'Tên Nhân vật từ 6 đến 16 ký tự và không chứa ký tự đặc biệt!!'});
		}else{
